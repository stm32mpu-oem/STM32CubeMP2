...
The *ThreadOne* starts to toggle the *LED3* each 500ms and <b>ThreadTwo</b> cannot as its priority is less than the *ThreadOne* threshold. 
...
Now, the <b>ThreadTwo</b> can preempt the <b>ThreadOne</b> and start toggling the *LED3* each 200ms for 5 seconds. Once done it send the <b>THREAD_TWO_EVT</b> to <b>MainThread</b>.
...
After repeating the sequence above 3 times, the <b>MainThread</b> should destroy <b>ThreadOne</b> and <b>ThreadTwo</b> and toggles the *LED3* each 1 second for ever.

####  <b>Expected success behavior</b>

  - LED3 toggles every 500ms for 5 seconds
  - LED3 toggles every 200ms for 5 seconds
  - Success status (After 3 times) :  'LED3' toggles every 1 second for ever.

#### <b>Error behaviors</b>

LED3 will be stay turned ON for ever if any error occurs.
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics VALID3 boards Revision: MB1706-A01.
...
In order to make the program work, you must do the following:
  ...
  - scp the signed firmware Tx_Thread_Creation_CM33_NonSecure_sign.bin to root@192.168.7.1:/home/root/Tx_Thread_Creation/lib/firmware
  - scp the script Firmware/Utilities/scripts/fw_cortex_m33.sh to root@192.168.7.1:/home/root/Tx_Thread_Creation/
  - To run the example on target: 
	  On target shell run:
	    - cd /home/root/Tx_Thread_Creation
