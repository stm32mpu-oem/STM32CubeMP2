...
- 'tx_app_thread':
  ...
  + On Success toggle the 'LED3' each 500ms for 5 seconds.
...
- 'ThreadTwo':
  + try to acquire the 'SyncObject' immediately.
  + On Success toggle the 'LED3' each 250ms for 5 seconds.
  + Release the 'SyncObject'
  + Sleep for 10ms.
  + Repeat the steps above.
...
#### <b>Expected success behavior</b>
  ...
  - 'LED3' toggles every 250ms for 5 seconds
...
In order to make the program work, you must do the following:
  ...
  - ssh root@192.168.7.1 'mkdir -p /home/root/Tx_Thread_Sync/lib/firmware'
  - scp the signed firmware Tx_Thread_Sync_CM33_NonSecure_sign.bin to root@192.168.7.1:/home/root/Tx_Thread_Sync/lib/firmware
  - scp the script Firmware/Utilities/scripts/fw_cortex_m33.sh to root@192.168.7.1:/home/root/Tx_Thread_Sync/
  - To run the example on target: 
	  On target shell run:
	    - cd /home/root/Tx_Thread_Sync
