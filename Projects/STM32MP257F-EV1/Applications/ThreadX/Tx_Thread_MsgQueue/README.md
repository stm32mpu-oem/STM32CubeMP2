...
<i>MsgReceiverThread</i> listen on both message queues :
  ...
  - When a message is available on <i>MsgQueueOne</i>, the <i>LED_ORANGE</i> is ON.
  - When a message is available on <i>MsgQueueTwo</i>, the <i>LED_ORANGE</i> is OFF.

####  <b>Expected success behavior</b>

<i>LED_ORANGE</i> gets ON every 200ms and <i>LED_ORANGE</i> gets OFF every 500ms if the application is running successfully.

#### <b>Error behaviors</b>

<i>LED_ORANGE</i> toggles every 1 second if any error occurs.
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics STM32MP257F-EV1 boards.
...
In order to make the program work, you must do the following :
 ...
 - Rebuild all Tx_Thread_MsgQueue application files and load your image into target memory
 - Run the application