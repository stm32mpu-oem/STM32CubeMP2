...
#define THREAD_APP_STACK_SIZE                512
#define THREAD_LED_STACK_SIZE                256
#define THREAD_OPENAMP_STACK_SIZE            2048
#define THREAD_USBPD_STACK_SIZE              2048

/* TX_APP_MEM_POOL_SIZE should be greater that the sum of the threadX stack size */
#define TX_APP_MEM_POOL_SIZE                 (14 *1024)
