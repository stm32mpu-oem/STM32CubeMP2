...
void HAL_RNG_MspInit(RNG_HandleTypeDef* hrng)
{
  ...
  /* Acquire RNG using Resource manager */
  if (ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP25_RIFSC_RNG_ID) == RESMGR_STATUS_ACCESS_OK)
  {
...
void HAL_RNG_MspDeInit(RNG_HandleTypeDef* hrng)
{
  ...
  /* Release RNG using Resource manager */
  if (ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP25_RIFSC_RNG_ID) == RESMGR_STATUS_ACCESS_OK)
  {
