...
SCL Pin: PZ4 (CN5, pin3)
SDA Pin: PZ3 (CN5, pin5)
...
In a first step after the user press the User USER1 push-button on the Master Board,
...
The second step starts when the user press once again the User USER1 push-button on the Master Board,
...
@par Hardware and Software environment
  ...
  - STM32MP257F-EV1 Set-ups
    - Connect I2C_SCL line of Master board (PZ4, CN5, pin3) to I2C_SCL line of Slave Board (PZ4, CN5, pin3).
    - Connect I2C_SDA line of Master board (PZ3, CN5, pin5) to I2C_SDA line of Slave Board (PZ3, CN5, pin5).
