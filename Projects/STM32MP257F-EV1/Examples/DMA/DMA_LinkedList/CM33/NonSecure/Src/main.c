...
/**
  ******************************************************************************
  * @file    DMA3/DMA3_LinkedList/CM33/NonSecure/Src/main.c
...
static void MX_DMA_DeInit(void)
{
  ...
  if (RESMGR_STATUS_ACCESS_OK != ResMgr_Release(RESMGR_RESOURCE_RIF_HPDMA3, RESMGR_HPDMA_CHANNEL(13)))
  {
	Error_Handler();
  }
  /* HPDMA3 clock enable */
  if(RESMGR_STATUS_ACCESS_OK != ResMgr_Release(RESMGR_RESOURCE_RIF_RCC, RESMGR_RCC_RESOURCE(85)))
  {
    Error_Handler();
  }
}
