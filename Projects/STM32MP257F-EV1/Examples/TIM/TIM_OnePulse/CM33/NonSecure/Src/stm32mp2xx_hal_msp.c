...
void HAL_TIM_OnePulse_MspDeInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM12)
  {
    ...
    */
	...
	if (RESMGR_STATUS_ACCESS_OK != ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOB, RESMGR_GPIO_PIN(11)))
	{
		Error_Handler();
	}
	/* Release TIM12 using Resource manager */
	if (RESMGR_STATUS_ACCESS_OK != ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP25_RIFSC_TIM12_ID))
	{
		Error_Handler();
	}
  }
