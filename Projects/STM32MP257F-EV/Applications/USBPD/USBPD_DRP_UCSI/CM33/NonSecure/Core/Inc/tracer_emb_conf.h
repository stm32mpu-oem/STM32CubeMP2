...
#else
#define TRACER_EMB_TX_GPIO_ENABLE_CLOCK()            LL_RCC_GPIOG_EnableClock()
#endif
#define TRACER_EMB_RX_GPIO                           GPIOG
#define TRACER_EMB_RX_PIN                            LL_GPIO_PIN_10
#define TRACER_EMB_RX_AF                             LL_GPIO_AF_5
#if defined(USE_OSTL_RIF_CONFIGURATION_ECOSYSTEM)
#define TRACER_EMB_RX_GPIO_ENABLE_CLOCK()
#else
#define TRACER_EMB_RX_GPIO_ENABLE_CLOCK()            LL_RCC_GPIOG_EnableClock()
#endif
...
#if defined(USE_OSTL_RIF_CONFIGURATION_ECOSYSTEM)
#define TRACER_EMB_ENABLE_CLK_DMA()
#else
#define TRACER_EMB_ENABLE_CLK_DMA()                  LL_RCC_HPDMA3_EnableClock()
#endif
