/**
  ...
  * @brief   This file provides the LL LPBAM functions for STM32MP2 devices.
  **********************************************************************************************************************
  * @attention
  *
                                        ...
                                        LPBAM_InfoDesc_t     *const pDescInfo)
{
  ...
  switch (pConfNode->NodeDesc.NodeInfo.NodeID)
  {
    ...
    {
      /* Set DMA request */
      pDescInfo->Request  = LPDMA_REQUEST_ADC4;
                                        ...
                                        LPBAM_InfoDesc_t     *const pDescInfo)
{
  ...
  switch (pConfNode->NodeDesc.NodeInfo.NodeID)
  {
    ...
    case LPBAM_DAC_DATA_ID:
    {
      ...
      {
        /* Set DMA request */
        pDescInfo->Request = LPDMA_REQUEST_DAC1_CH1;
      }
      else if (pConfNode->Config.Channel == LPBAM_DAC_CHANNEL_2)
      {
        /* Set DMA request */
        pDescInfo->Request = LPDMA_REQUEST_DAC1_CH2;
        /* Set channel offset */
                                        ...
                                        LPBAM_InfoDesc_t     *const pDescInfo)
{
  ...
  switch (pConfNode->NodeDesc.NodeInfo.NodeID)
  {
    ...
    case LPBAM_I2C_CONFIG_TRANSACTION_ID:
    {
      ...
      {
        pDescInfo->Request   = LPDMA_REQUEST_I2C3_EVC;
          ...
          if (pConfNode->Config.ReloadDataState == ENABLE)
          {
            ...
            else
            {
              ...
              if (pConfNode->Config.SequentialDataState == DISABLE)
              {
                ...
                if ((xfer_cplt_it_state == ENABLE) || ((pConfNode->pInstance->CR1 & I2C_CR1_TCIE) == I2C_CR1_TCIE))
                {
    ...
    case LPBAM_I2C_TRANSMIT_DATA_ID:
    {
      ...
      pDescInfo->Request  = LPDMA_REQUEST_I2C3_TX;
    ...
    case LPBAM_I2C_RECEIVE_DATA_ID:
    {
      ...
      pDescInfo->Request  = LPDMA_REQUEST_I2C3_RX;
    ...
    case LPBAM_LPTIM_CONFIG_ID:
    {
      ...
      else
      {
        ...
        if (pConfNode->Config.Mode == LPBAM_LPTIM_CM_MODE)
        {
          ...
          {
            /* Set LPTIM update event request */
            pDescInfo->Request = LPDMA_REQUEST_LPTIM1_UE;
          }
          else
          {
            /* Set LPTIM update event request */
            pDescInfo->Request = LPDMA_REQUEST_LPTIM3_UE;
          }
        }
      }
    ...
    case LPBAM_LPTIM_INPUT_CAPTURE_ID:
    {
      ...
      if (pConfNode->Config.Channel == LPBAM_LPTIM_CHANNEL_1)
      {
        ...
        if (pConfNode->pInstance == LPTIM1)
        {
          ...
          pDescInfo->Request = LPDMA_REQUEST_LPTIM1_IC1;
        }
        else
        {
          /* Set input capture DMA request */
          pDescInfo->Request = LPDMA_REQUEST_LPTIM3_IC1;
        }
      }
      /* LPTIM channel 2 */
      else
      {
        ...
        {
          /* Set input capture DMA request */
          pDescInfo->Request = LPDMA_REQUEST_LPTIM1_IC2;
        }
        else
        {
          /* Set input capture DMA request */
          pDescInfo->Request = LPDMA_REQUEST_LPTIM3_IC2;
        }
      }
                                        ...
                                        LPBAM_InfoDesc_t     *const pDescInfo)
{
  ...
  switch (pConfNode->NodeDesc.NodeInfo.NodeID)
  {
    ...
    {
      /* Select request for transmit data node */
      pDescInfo->Request  = LPDMA_REQUEST_SPI3_TX;
    ...
    {
      /* Select request for receive data node */
      pDescInfo->Request  = LPDMA_REQUEST_SPI3_RX;
                                         ...
                                         LPBAM_InfoDesc_t      *const pDescInfo)
{
  ...
  switch (pConfNode->NodeDesc.NodeInfo.NodeID)
  {
    ...
    {
      /* Set node information */
      pDescInfo->Request  = LPDMA_REQUEST_LPUART1_TX;
      /* Set DMA source address */
      pDescInfo->SrcAddr  = (uint32_t)pConfNode->NodeDesc.pBuff;
      /* Set DMA destination address */
      pDescInfo->DstAddr  = LPBAM_UART_DescItem_Tbl[pConfNode->NodeDesc.NodeInfo.NodeID].RegOffset +
    ...
    {
      /* Set node information */
      pDescInfo->Request  = LPDMA_REQUEST_LPUART1_RX;
      /* Set DMA source address */
