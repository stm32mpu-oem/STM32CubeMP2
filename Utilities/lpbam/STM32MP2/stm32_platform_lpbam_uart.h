...
#define LPBAM_LPUART_EXTI_LINE4_TRG     (0x04U) /*!< LPBAM LPUART HW Trigger signal is EXTI line 4      */
#define LPBAM_LPUART_EXTI_LINE5_TRG     (0x05U) /*!< LPBAM LPUART HW Trigger signal is EXTI line 5      */
#define LPBAM_LPUART_LPTIM3_CH1_TRG     (0x07U) /*!< LPBAM LPUART HW Trigger signal is LPTIM3 CH1       */
#define LPBAM_LPUART_LPTIM4_CH1_TRG     (0x08U) /*!< LPBAM LPUART HW Trigger signal is LPTIM4 CH1       */
#define LPBAM_LPUART_LPTIM5_OUT_TRG     (0x08U) /*!< LPBAM LPUART HW Trigger signal is LPTIM5 OUT       */
