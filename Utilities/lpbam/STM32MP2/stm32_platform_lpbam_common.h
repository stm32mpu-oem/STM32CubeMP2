...
/** @defgroup LPBAM_DMA_Trigger_Selection LPBAM DMA Trigger Selection
  * @{
  */
#define LPBAM_LPDMA_TRIGGER_EXTI_LINE0      (0U)  /*!< LPBAM LPDMA HW Trigger signal is EXTI_LINE0      */
#define LPBAM_LPDMA_TRIGGER_EXTI_LINE1      (1U)  /*!< LPBAM LPDMA HW Trigger signal is EXTI_LINE1      */
#define LPBAM_LPDMA_TRIGGER_EXTI_LINE2      (2U)  /*!< LPBAM LPDMA HW Trigger signal is EXTI_LINE2      */
#define LPBAM_LPDMA_TRIGGER_EXTI_LINE3      (3U)  /*!< LPBAM LPDMA HW Trigger signal is EXTI_LINE3      */
#define LPBAM_LPDMA_TRIGGER_EXTI_LINE4      (4U)  /*!< LPBAM LPDMA HW Trigger signal is EXTI_LINE4      */
#define LPBAM_LPDMA_TRIGGER_TAMP_TRG1       (5U)  /*!< LPBAM LPDMA HW Trigger signal is TAMP_TRG1       */
#define LPBAM_LPDMA_TRIGGER_TAMP_TRG2       (6U)  /*!< LPBAM LPDMA HW Trigger signal is TAMP_TRG2       */
#define LPBAM_LPDMA_TRIGGER_TAMP_TRG3       (7U)  /*!< LPBAM LPDMA HW Trigger signal is TAMP_TRG3       */
#define LPBAM_LPDMA_TRIGGER_LPTIM1_CH1      (8U)  /*!< LPBAM LPDMA HW Trigger signal is LPTIM1_CH1      */
#define LPBAM_LPDMA_TRIGGER_LPTIM1_CH2      (9U)  /*!< LPBAM LPDMA HW Trigger signal is LPTIM1_CH2      */
#define LPBAM_LPDMA_TRIGGER_LPTIM3_CH1      (10U) /*!< LPBAM LPDMA HW Trigger signal is LPTIM3_CH1      */
#define LPBAM_LPDMA_TRIGGER_LPTIM4_OUT      (11U) /*!< LPBAM LPDMA HW Trigger signal is LPTIM4_OUT      */
#define LPBAM_LPDMA_TRIGGER_COMP1_OUT       (12U) /*!< LPBAM LPDMA HW Trigger signal is COMP1_OUT       */
#define LPBAM_LPDMA_TRIGGER_COMP2_OUT       (13U) /*!< LPBAM LPDMA HW Trigger signal is COMP2_OUT       */
#define LPBAM_LPDMA_TRIGGER_RTC_ALRA_TRG    (14U) /*!< LPBAM LPDMA HW Trigger signal is RTC_ALRA_TRG    */
#define LPBAM_LPDMA_TRIGGER_RTC_ALRB_TRG    (15U) /*!< LPBAM LPDMA HW Trigger signal is RTC_ALRB_TRG    */
#define LPBAM_LPDMA_TRIGGER_RTC_WUT_TRG     (16U) /*!< LPBAM LPDMA HW Trigger signal is RTC_WUT_TRG     */
#define LPBAM_LPDMA_TRIGGER_ADC4_AWD1       (17U) /*!< LPBAM LPDMA HW Trigger signal is ADC4_AWD1       */
#define LPBAM_LPDMA_TRIGGER_LPDMA_CH0_TCF  (18U) /*!< LPBAM LPDMA HW Trigger signal is LPDMA_CH0_TCF  */
#define LPBAM_LPDMA_TRIGGER_LPDMA_CH1_TCF  (19U) /*!< LPBAM LPDMA HW Trigger signal is LPDMA_CH1_TCF  */
#define LPBAM_LPDMA_TRIGGER_LPDMA_CH2_TCF  (20U) /*!< LPBAM LPDMA HW Trigger signal is LPDMA_CH2_TCF  */
#define LPBAM_LPDMA_TRIGGER_LPDMA_CH3_TCF  (21U) /*!< LPBAM LPDMA HW Trigger signal is LPDMA_CH3_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH0_TCF  (22U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH0_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH1_TCF  (23U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH1_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH4_TCF  (24U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH4_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH5_TCF  (25U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH5_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH6_TCF  (26U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH6_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH7_TCF  (27U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH7_TCF  */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH12_TCF (28U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH12_TCF */
#define LPBAM_LPDMA_TRIGGER_HPDMA_CH13_TCF (29U) /*!< LPBAM LPDMA HW Trigger signal is HPDMA_CH13_TCF */
#define LPBAM_LPDMA_TRIGGER_TIM2_TRGO       (30U) /*!< LPBAM LPDMA HW Trigger signal is TIM2_TRGO       */
#define LPBAM_LPDMA_TRIGGER_TIM15_TRGO      (31U) /*!< LPBAM LPDMA HW Trigger signal is TIM15_TRGO      */
/**
  * @}
  */
