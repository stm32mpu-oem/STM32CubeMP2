  ...
  ======================================================================================================================
    ...
    *** Driver APIs description ***
    ...
    [..]
      ...
      (high or low) according to configured parameters in the LPBAM_COMP_OutLevelFullAdvConf_t structure.
      The configuration parameters are :
    ...
    *** Recommendation ***
    ...
    [..]
      It's strongly recommended to ensure that InputPlus and InputMinus signals are configured when calling
      ADV_LPBAM_COMP_Start_SetFullQ().

    [..]
      When the comparator is configured on input window mode, the input plus will be shared between the two comparator
      instances.
      For the comparator instance which is not driving the window mode InputPlus parameter configuration has no effect.
