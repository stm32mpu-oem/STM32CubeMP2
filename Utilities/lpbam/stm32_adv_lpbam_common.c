  ...
  ======================================================================================================================
    ...
    *** Driver functions model ***
    ...
    [..]
      This driver provides only one model of API :
          (+) ADV_LPBAM_{Module}_Set{Mode}Config() : provides configuration for input queue.
          (+) ADV_LPBAM_{Module}_Set{Mode}Mode()   : provides circularity configuration for input queue.
    ...
    [..]
      This driver provides services covering the LPBAM management of the following COMMON features :
          (+) Set a data configuration transfer for advanced APIs that supports data transfers.
              Check @ref LPBAM_Q_Data_Node_Selection to have the exhaustive list of APIs that supports this capability.
          (+) Set a hardware trigger signal for a built linked-list queue execution and data transfers.
              Check @ref LPBAM_Q_Config_Node_Selection and @ref LPBAM_Q_Data_Node_Selection to have the exhaustive list
              of APIs that supports this capability.
          (+) Set a circular mode for a built linked-list queue.
              Check @ref LPBAM_Q_Config_Node_Selection and @ref LPBAM_Q_Data_Node_Selection to have the exhaustive
              list of APIs that supports this capability.
    ...
    *** Driver APIs description ***
    ...
    [..]
      ...
      Trigger The configuration parameters are :
