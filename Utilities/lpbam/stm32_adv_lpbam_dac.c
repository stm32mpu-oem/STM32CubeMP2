  ...
  **********************************************************************************************************************
  ...
  ======================================================================================================================
    ...
    [..]
      This driver user sequence is :
          ...
          (+) There are two possibilities to call advanced API:
              ...
              (++) Two APIs making configuration and data setup sperately :
    ...
    *** Recommendations ***
    ...
    [..]
      If you are using simultaneously the 2 DAC channels (in two different queues), it's forbidden to re-configure the
      DAC using ADV_LPBAM_DAC_Conversion_SetConfigQ() or ADV_LPBAM_DAC_Conversion_SetFullQ() APIs.

    [..]
      It's not allowed to re-configure a DAC channel while the other DAC channel is running using
