  ...
  ======================================================================================================================
    ...
    *** Driver APIs description ***
    ...
    [..]
      ...
      Example : HeadQAddress = (uint32_t)User_Q.Head where User_Q is a varibale of type DMA_QListTypeDef.
    ...
    *** Driver user sequence ***
    ...
    [..]
      This driver user sequence is :
          ...
          (+) Call HAL_DMAEx_List_Init() to initialize a master DMA channel in linked-list mode.
              (Mandatory)
    ...
    *** Recommendation ***
    ...
    [..]
      It's recommended to ensure the consistency of used channel and queues when using ADV_LPBAM_DMA_Start_SetFullQ()
      API at run time.
