  ...
  ======================================================================================================================
    ...
    *** Driver APIs description ***
    ...
    [..]
      ...
      This API allow to write the state of one or multiple pin(s). The pin(s) state is written oneshot.
    ...
    [..]
      ...
      This API allow to write the state of one or multiple pin(s). The pin(s) state can be written oneshot or several
    ...
    [..]
      ...
      __LPBAM_GPIO_STATE() macro to get separately the state of each selected pin.
    ...
    *** Recommendation ***
    ...
    [..]
      It's forbidden to call ADV_LPBAM_GPIO_WritePin_SetFullQ(), ADV_LPBAM_GPIO_WritePinSequence_SetFullQ with the same
      pin(s) in two different queues.
    ...
    [..]
      For reading and writing pin(s) cadency, use a DMA channel hardware trigger signal through
