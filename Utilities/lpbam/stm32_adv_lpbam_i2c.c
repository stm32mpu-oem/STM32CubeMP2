  ...
  **********************************************************************************************************************
  ...
  ======================================================================================================================
    ...
    *** Driver APIs description ***
    ...
    [..]
      Use ADV_LPBAM_I2C_MasterStopGeneration_SetFullQ() API to build a linked-list queue that setup the generation of
      stop condition by the I2C master.
...
/**
  * @brief  Build DMA linked-list queue to generate a stop condition by the I2C master.
