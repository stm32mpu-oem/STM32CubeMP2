/**
  ******************************************************************************
  * @file    stm32mp257cxx_validx_usbpd_pwr.c
...
/* Includes ------------------------------------------------------------------*/
#include "stm32mp257cxx_validx_usbpd_pwr.h"
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Exported_Variables Exported Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Private_Typedef Private Typedef
  * @{
  */
/**
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Private_Macros Private Macros
  * @{
  */
#ifdef _TRACE
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Private_Variables Private Variables
  * @{
  */
...
/** @addtogroup STM32MP257CXX_VALIDX_USBPD_PWR_Exported_Functions
  * @{
  */
...
int32_t BSP_USBPD_PWR_VBUSGetVoltage(uint32_t PortNum, uint32_t *pVoltage)
{
  ...
  else
  {
    ...
    voltage = PWR_TCPP0203_ConvertADCDataToVoltage(adc_value, STM32MP257CXX_VALIDX_VSENSE_RA, STM32MP257CXX_VALIDX_VSENSE_RB);
    *pVoltage = voltage;
  }
  return ret;
}
...
/** @addtogroup STM32MP257CXX_VALIDX_USBPD_PWR_Private_Functions
  * @{
  */
