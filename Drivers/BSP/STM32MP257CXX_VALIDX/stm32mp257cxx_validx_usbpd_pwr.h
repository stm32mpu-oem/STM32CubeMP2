/**
  ******************************************************************************
  * @file    stm32mp257cxx_validx_usbpd_pwr.h
  * @author  MCD Application Team
  * @brief   Header file for stm32mp257cxx_validx_usbpd_pwr.c file
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32MP257CXX_VALIDX_USBPD_PWR_H
#define STM32MP257CXX_VALIDX_USBPD_PWR_H
...
/** @addtogroup STM32MP257CXX_VALIDX_USBPD_PWR
  * @{
  */

/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Exported_Types Exported Types
  * @{
  */
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Exported_Constants Exported Constants
  * @{
  */
/**
...
#define TCPP0203_PORT0_FLG_GPIO_PIN                 LL_GPIO_PIN_3
...
#define TCPP0203_PORT0_VBUSC_GPIO_PORT              GPIOB
#define TCPP0203_PORT0_VBUSC_GPIO_PIN               LL_GPIO_PIN_15
...
#define STM32MP257CXX_VALIDX_VSENSE_RA              140U /* VBUS voltage divider RA in kiloohm */
#define STM32MP257CXX_VALIDX_VSENSE_RB              10U  /* VBUS voltage divider RB in kiloohm */

/**
  * @}
  */

/** @addtogroup STM32MP257CXX_VALIDX_USBPD_PWR_Exported_Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32MP257CXX_VALIDX_USBPD_PWR_Exported_Functions Exported Functions
  * @{
  */
/* Common functions */
...
#endif /* STM32MP257CXX_VALIDX_USBPD_PWR_H */
